...
(function ($) {
  ...
  var CountdownImagePhysicalWidth = 38;
  var CountdownImagePhysicalHeight = 65;
  var ImagePhysicalWidth = 38;
  var ImagePhysicalHeight = 40;
  var CWidth = 0;
  if ($(window).width() > 400) {
    CWidth = 358;
  }
    ...
    function d() {
      if (!g) {
        ...
        if (a) {
          var d;
          (function () {
              if (!f) if (document.readyState != "loaded" && document.readyState != "complete") setTimeout(function () {}, 0);
                else {
                  if (d === void 0) {
...
(function () {
    ...
    a.cssPrefix = "";
    if (a.chrome || a.safari) if (a.cssPrefix = "webkit", a.chrome && a.version < 10) a.oldWebkit = true;
      else {
    ...
    b.G = function () {
      if (this.text != "") {
        ...
        if (this.textSize) a = this.textSize, b.lineHeight = "1em";
          ...
          var c = this.width,
            d = this.height;
          if (c > 0 && d > 0) if (this.textFit == "wh") a = a = c < d ? c : d, a = this.textScale > 0 ? a * this.textScale : a;
...
var CountdownImageFolder = "http://dev.aventurecolombia.com/aventure-colombia/sites/all/modules/custom/pre_blocks/images/",
  CountdownImageExt = "png",
  CountdownImagePhysicalWidth = ImagePhysicalWidth,
  CountdownImagePhysicalHeight = ImagePhysicalHeight,
  CountdownWidth = CWidth,
  CountdownHeight = 1;
(function () {
    var c = function (a) {
    ...
    b.init = function () {
      ...
      this.height = 87 || CountdownHeight;
