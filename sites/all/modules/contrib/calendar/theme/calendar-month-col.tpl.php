...
if (isset($item['day_of_month']) && $item['day_of_month']%2 == 0) 
	$type = " par";
else
	$type = " impar";
?>
<td <?php print $id?>class="<?php print $item['class']; print $type; ?>" colspan="<?php print $item['colspan'] ?>" rowspan="<?php print $item['rowspan'] ?>"<?php print $date . $headers . $day; ?>>
  <div class="inner">
