     ...
     <div class="redes_footer">
      <div id="find-us">
        ...
        <div class="bot_redes">
          ...
          <div class="pinterest-footer"></div>
        </div>
      </div>
     </div>
      <div id="footer-wrapper">
        <div class="row">
          ...
          <!-- end contact-info -->
          <div id="contact-form" class="large-4 columns">
            <?php if ($page['foot_contact_form']): ?>
              <?php print render($page['foot_contact_form']); ?>
            <?php endif; ?>
          </div>
          <!-- end contact-form -->
          <div id="contact-links" class="large-4 columns">
            <?php if ($page['foot_links']): ?>
              <?php print render($page['foot_links']); ?>
            <?php endif; ?>
          </div>
          <!-- end contact-links -->
        </div>
